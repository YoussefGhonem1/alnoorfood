          ...
          child: Stack(
            children: [
              SizedBox(
                width: 100.w,
                height: 100.h,
                child: _controller==null?const SizedBox():GestureDetector(
                ...
                child: Column(
                  children: [
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: List.generate(images.length, (index){
                              return InkWell(
                                onTap: (){
                                  navP(ImagesPreviewWidget(images: images,index: index,),);
                                },
                                child: SizedBox(
                                  width: 14.w,
                                  height: 10.h,
                                  child: Stack(
                                    children: [
                                      ...
                                      PositionedDirectional(top: 0,start: 0,child: InkWell(
                                          onTap: (){
                                            images.removeAt(index);
                                            setState(() {

                                            });
                                          },child: Icon(Icons.remove_circle,color: Colors.red,size: 4.w,))),
                                    ],
                                  ),
                                ),
                              );
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.symmetric(horizontal: 5.w,vertical: 2.h).add(EdgeInsets.only(bottom: 4.h)),
                      child: Center(
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // SizedBox(height: 1.h,),
                                  Text(LanguageProvider.translate('global', 'change_camera'),style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 12.sp
                                  ),)
                                ],
                            ...
                            if(widget.multiple)IconButton(onPressed: (){
                              _takeImage();
                            }, icon: Icon(Icons.add,color: Colors.white,size: 8.w,),),
                            if((widget.multiple&&images.isNotEmpty)||!widget.multiple)ButtonWidget(onTap: (){
                              _save();
                            }, text: 'save',width: 20.w,height: 4.5.h,color: Colors.white,
                              textStyle: TextStyleClass.smallStyle(color: Colors.black),borderRadius: 25,)
                            else SizedBox(width: 20.w,),
                          ],
                        ),
                      ),
                    ),
